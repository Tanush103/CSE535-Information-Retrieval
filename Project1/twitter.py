...
class Twitter:
    def __init__(self):
        self.auth = tweepy.OAuthHandler("IAmRankRCgca5Y9aRV65CHYkN", "fA64E97wMva5ptr0Avc9PBuMyAURXcroOmJhGk76BlTNq9XZJp")
        self.auth.set_access_token("1432401848527466497-S8dl6gowxVo19Gz301LJGM5pplCVON", "brQ6hLE7YkVY6hWLvVv9mXCynVfQfsiCGvEBrcthQ9E4q")
